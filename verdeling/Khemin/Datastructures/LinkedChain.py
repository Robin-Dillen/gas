...
class LinkedChain:
    ...
    # Een methode die de LinkedChain doorloopt op zoek naar het gegeven value.
    #
    # return: id, True als het item met gegegeven id in de LinkedChain aanwezig is, anders None, False.
